...
# FILENAME: cnn.py
# SPECIFICATION: Reads numbers based on their image
...
train_path = os.path.join("/Users/timothytsang/CS/PyCharm/Assignment4/digit_dataset/train")
test_path = os.path.join("/Users/timothytsang/CS/PyCharm/Assignment4/digit_dataset/test")
...
# --> add your Python code here
X_train, Y_train = load_digit_images_from_folder("/Users/timothytsang/CS/PyCharm/Assignment4/digit_dataset/train")
X_test, Y_test = load_digit_images_from_folder("/Users/timothytsang/CS/PyCharm/Assignment4/digit_dataset/test")
...
model = models.Sequential([
    ...
    # --> add your Python code here
    layers.Conv2D(32, (2,3), activation = "relu", input_shape = (32,32,1)),
...
# --> add your Python code here
model.compile(optimizer= "sgd", loss= SparseCategoricalCrossentropy(from_logits = False), metrics=["accuracy"])
